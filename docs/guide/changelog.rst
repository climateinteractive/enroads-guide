...
- The Temperature change reported is now relative to 19th century.
...
New
^^^^^
- Added several graphs related to renewable energy: Low Carbon Average Cost of Electricity Production by Source; Low Carbon Marginal Cost of Electricity Production by Source; Renewables Capacity— Area
...
- Fix "Reset Graphs" now restores the correct default graphs. 
